...
class BackgroundService : Service() {
    ...
    override fun onCreate() {
        ...
        val filter =
            IntentFilter(Intent.ACTION_SCREEN_ON).also { it.addAction(Intent.ACTION_SCREEN_OFF) }
    ...
    private fun postNotification() {
        ...
        val builder: Notification.Builder = Notification.Builder(this, "background").also {
